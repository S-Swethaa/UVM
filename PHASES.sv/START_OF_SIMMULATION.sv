...
//start od simulation phase which is used to initialize the values 
//this phase which is before start the simulation build using function 
//display testbench settings
//verify the config db values
//which helps start of simulation phase function void start_of_simulation_phase();
module or_gate(
  input wire [3:0]a,b,
  output [3:0]y);
...
#    Time: 0 ns  Iteration: 30  Process: /uvm_pkg::uvm_phase::m_run_phases/#FORK#2213_7f2a843e7b7 File: environment.sv Line: 30
