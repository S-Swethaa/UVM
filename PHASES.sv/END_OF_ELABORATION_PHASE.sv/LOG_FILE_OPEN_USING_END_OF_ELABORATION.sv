...
// uvm_topology we need print using end of elaboration phase ,and we  know the top down methodology how it works 
//using end_of_elaboration phase which is more helpful
//using function to write end of elaboration phase
//to print the topology using uvm_top.print_topology();
//using to save the report file redirect.we need to store the info warning error fatal and file should save using end of elaboration
//must to write the top environment then know whow it works easilyy.
module or_gate(
  input wire [3:0]a,b,
  output [3:0]y);
...
# UVM_INFO environment.sv(34) @ 0: uvm_test_top.env [EOE] file opened successfully
