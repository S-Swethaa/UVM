...
// uvm_topology we need print using end of elaboration phase we need to know the top down methodology how it works 
//using end_of_elaboration phase which is more helpful
//using function to write end of elaboration phase
//tp print the topology using uvm_top.print_topology();
//must to write the top environment then kno whow it works easilyy.
module or_gate(
  input wire [3:0]a,b,
  output [3:0]y);
...
# UVM_INFO environment.sv(23) @ 0: uvm_test_top.env [EOE_TOPO] ==== UVM TOPOLOGY START ====
...
# --------------------------------------------------------------
# 
# UVM_INFO environment.sv(27) @ 0: uvm_test_top.env [EOE_TOPO] ==== UVM TOPOLOGY END ====
