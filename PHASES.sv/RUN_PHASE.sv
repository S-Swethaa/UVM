...
# UVM_INFO design.sv(213) @ 0: uvm_test_top.env [EOE_TOPO] ==== UVM TOPOLOGY START ====
...
#         seq_item_port      uvm_seq_item_pull_port  -     @528 
#       mon                  monitor                 -     @546 
#         ap                 uvm_analysis_port       -     @555 
#       seqr                 sequencer               -     @397 
#         rsp_export         uvm_analysis_export     -     @405 
#         seq_item_export    uvm_seq_item_pull_imp   -     @511 
#         arbitration_queue  array                   0     -    
#         lock_queue         array                   0     -    
#         num_last_reqs      integral                32    'd1  
#         num_last_rsps      integral                32    'd1  
#     scb                    scoreboard              -     @388 
#       ap_imp               uvm_analysis_imp        -     @570 
# --------------------------------------------------------------
# 
# UVM_INFO design.sv(217) @ 0: uvm_test_top.env [EOE_TOPO] ==== UVM TOPOLOGY END ====
# UVM_INFO design.sv(223) @ 0: uvm_test_top.env [EOE] file opened successfully
# UVM_INFO design.sv(82) @ 0: uvm_test_top.env.agnt.drv [ SOS DRIVER] intial values are reset in intial state 
# UVM_INFO design.sv(255) @ 0: uvm_test_top [PRE_RESET] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(262) @ 0: uvm_test_top [RESET] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(269) @ 0: uvm_test_top [POST_RESET] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(276) @ 0: uvm_test_top [PRE_CONFIGURE] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(283) @ 0: uvm_test_top [CONFIGURE] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(290) @ 0: uvm_test_top [POST_CONFIGURE] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(297) @ 0: uvm_test_top [PRE_MAIN] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(304) @ 0: uvm_test_top [MAIN] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(311) @ 0: uvm_test_top [POST_MAIN] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(318) @ 0: uvm_test_top [PRE_SHUTDOWN] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(325) @ 0: uvm_test_top [SHUTDOWN] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(332) @ 0: uvm_test_top [POST_SHUTDOWN] Type=test, FullName=uvm_test_top
# UVM_INFO design.sv(180) @ 6: uvm_test_top.env.scb [SB] PASS: a=11, b=12, y=15
# UVM_INFO design.sv(180) @ 16: uvm_test_top.env.scb [SB] PASS: a=4, b=11, y=15
# UVM_INFO design.sv(180) @ 26: uvm_test_top.env.scb [SB] PASS: a=9, b=9, y=9
# UVM_INFO design.sv(180) @ 36: uvm_test_top.env.scb [SB] PASS: a=2, b=11, y=11
# UVM_INFO design.sv(180) @ 46: uvm_test_top.env.scb [SB] PASS: a=6, b=1, y=7
# UVM_INFO design.sv(180) @ 56: uvm_test_top.env.scb [SB] PASS: a=8, b=11, y=11
# UVM_INFO design.sv(180) @ 66: uvm_test_top.env.scb [SB] PASS: a=12, b=9, y=13
# UVM_INFO design.sv(180) @ 76: uvm_test_top.env.scb [SB] PASS: a=15, b=0, y=15
# UVM_INFO design.sv(180) @ 86: uvm_test_top.env.scb [SB] PASS: a=4, b=9, y=13
# UVM_INFO design.sv(180) @ 96: uvm_test_top.env.scb [SB] PASS: a=11, b=1, y=11
# UVM_INFO design.sv(180) @ 106: uvm_test_top.env.scb [SB] PASS: a=2, b=13, y=15
# UVM_INFO design.sv(180) @ 116: uvm_test_top.env.scb [SB] PASS: a=4, b=4, y=4
# UVM_INFO design.sv(180) @ 126: uvm_test_top.env.scb [SB] PASS: a=14, b=11, y=15
# UVM_INFO design.sv(180) @ 136: uvm_test_top.env.scb [SB] PASS: a=5, b=12, y=13
# UVM_INFO design.sv(345) @ 145: uvm_test_top [RUN_PHASE] Type=test, FullName=uvm_test_top
