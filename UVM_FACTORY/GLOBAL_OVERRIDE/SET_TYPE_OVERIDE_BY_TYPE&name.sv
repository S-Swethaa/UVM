...
class test extends uvm_test;
  ...
  function void build_phase(uvm_phase phase);
    ...
    uvm_factory::get().set_type_override_by_type(
      driver::get_type(),
      extend_driver::get_type()
    );
    `uvm_info("test","factory override successfully done by set_type_override_by_type", UVM_LOW)

    uvm_factory::get().set_type_override_by_name(
      "driver",
      "extend_driver"
    );
    `uvm_info("test","factory override successfully done by set_type_override_by_name", UVM_LOW)
...
# UVM_INFO test.sv(20) @ 0: uvm_test_top [test] factory override successfully done by set_type_override_by_type
# UVM_INFO @ 0: reporter [TPREGR] Original object type 'driver' already registered to produce 'extend_driver'.  Replacing with override to produce type 'extend_driver'.
# UVM_INFO test.sv(26) @ 0: uvm_test_top [test] factory override successfully done by set_type_override_by_name
...
#    Time: 0 ns  Iteration: 30  Process: /uvm_pkg::uvm_phase::m_run_phases/#FORK#2213_7f24003e85c File: environment.sv Line: 30
...
# End time: 13:45:50 on Jun 10,2026, Elapsed time: 0:00:03
# Errors: 1, Warnings: 1
End time: 13:45:50 on Jun 10,2026, Elapsed time: 0:00:17
*** Summary *********************************************
