...
class sequenc extends uvm_sequence #(sequence_item);
  ...
  virtual task body();
    ...
    repeat (2) begin
      ...
      `uvm_do(seq)// macro handle automatically wait for grant,randomize and send the trasaction and wait for item done
...
# UVM_INFO testbench.sv(54) @ 0: uvm_test_top.e.agnt.drv [driver] driver dending the requenst to get next transaction
# UVM_INFO testbench.sv(57) @ 10: uvm_test_top.e.agnt.drv [driver] driver actively driveing to dut send responce to sequene
...
# UVM_INFO testbench.sv(54) @ 10: uvm_test_top.e.agnt.drv [driver] driver dending the requenst to get next transaction
# UVM_INFO testbench.sv(57) @ 20: uvm_test_top.e.agnt.drv [driver] driver actively driveing to dut send responce to sequene
